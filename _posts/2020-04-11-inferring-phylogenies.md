...
Assigning time scales to branching points, or __phylodynamic__ modeling, can be done using [treetime](https://github.com/neherlab/treetime). `TreeTime` works on a number of file types, including FASTA, PHYLIP, and VCF.
