...
I should note that while the tools are readily available, _eg._ [here](https://www.idmod.org/software), epidemiologic models require considerable expertise to properly build an interpret, and are [prone to misuse by novices](https://www.tableau.com/about/blog/2020/4/you-are-almost-definitely-not-qualified-make-predictions-about-covid-19).
