...
Since the most popular implementation of AI is chatbots, it's hardly surprising that there have been many attempts to implement AI biology expert systems. [BioArena](https://bioarena.ai). [Med-PaLM and its follow-up Med-PaLM 2](https://sites.research.google/gr/med-palm/) can answer medical questions drawn from the USMLE. [Heidi](https://www.heidihealth.com/en-us/evidence) can answer clinical questions.
...
Deep learning have been applied to H&E slides to predict mutations (inception v3), molecular phenotypes ([PACpAInt](https://github.com/owkin/pacpaint)), transcriptomic levels ([HE2RNA](https://github.com/owkin/HE2RNA_code)) and patient outcomes ([MesoNet](https://pubmed.ncbi.nlm.nih.gov/31591589/)).
